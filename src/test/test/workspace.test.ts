...
// import { getCacheStub, getConfigStub } from "../util/stubFactory";

// describe("Workspace", () => {
//   let cacheStub: Cache = getCacheStub();
//   // let utilsStub: Utils = getUtilsStub();
//   let configStub: Config = getConfigStub();
//   let workspace: Workspace = new Workspace(cacheStub, configStub);
...
//     workspace = new Workspace(cacheStub, configStub);
